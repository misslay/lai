  ...
  <table align="center">
   <tr><td> <ul class="navbar-nav">
	...
	<div class="row">
		...
		<form action="newpost_action.php" method="post" class="" enctype="multipart/form-data">
		<div class="panel-body">
		
			<div class="form-group">
			<label>Article Title:</label><br><input type="text" name="title" required>
			</div>
		
			<div class="form-group">
			<label>Description:</label><br><textarea name="desc" rows="10" cols="30" required></textarea>
			</div>
			
			<div class="form-group">
			<label>Add Image:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="file" name="image" required>
			</div>
		
			<div class="form-group">
			<p align="center"><button type="submit" class="btn btn-primary">Upload</button></p>
			</div>
